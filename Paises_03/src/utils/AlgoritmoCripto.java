...
public class AlgoritmoCripto {
	...
	public String cryptoMD5(String senha) throws NoSuchAlgorithmException, UnsupportedEncodingException {
	...
	public String cryptoSHA(String senha) throws NoSuchAlgorithmException, UnsupportedEncodingException {
	...
	public String cryptoSHAHex(String senha) throws NoSuchAlgorithmException, UnsupportedEncodingException {
		MessageDigest algoritmoCrypto = MessageDigest.getInstance("SHA-256");
